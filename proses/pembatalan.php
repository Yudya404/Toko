...
if (isset($_POST['submit'])) {
    ...
    $alasan_pembatalan = mysqli_real_escape_string($conn, $_POST['alasan_pembatalan']);
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        $update_sql = "UPDATE t_pesanan SET status = 'Pesanan Dibatalkan', tgl_batal = '$tgl_pembatalan' WHERE kode_p = '$kode_p'";
            ...
            if ($get_detail_data) {
                ...
                echo "
                    <script>
                        ...
                        window.location = '../riwayat_belanja.php';
                    </script>
                ";
            } else {

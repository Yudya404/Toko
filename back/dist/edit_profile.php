										...
										<div class="card-body pt-9 pb-0">
											...
											<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
												...
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-1" href="overview.php">Detail Profil</a>
												</li>
												<!--end::Nav item-->
												<!--begin::Nav item-->
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-1 active" href="edit_profile.php">Edit Profile</a>
												</li>
												<!--end::Nav item-->
											</ul>
											<!--begin::Navs-->
												...
												<div class="card-body border-top p-9">
													...
													<div class="row mb-6">
														...
														<div class="col-lg-8">
															...
															<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
																...
																<div class="image-input-wrapper w-125px h-125px" style="background-image: url('proses/<?= $_SESSION['foto_user']; ?>')"></div>
													...
													<div class="row mb-6">
														...
														<div class="col-lg-8 fv-row">
															<input type="text" id="user_id" class="form-control form-control-lg form-control-solid" disabled value="<?= $_SESSION['kode_user'];  ?>" />
															<input type="hidden" name="user_id" class="form-control form-control-solid mb-3 mb-lg-0" id="user_id"  value="<?= $_SESSION['kode_user']; ?>">
														</div>
														<!--end::Col-->
													</div>
													<!--end::Input group-->
													...
													<div class="row mb-6">
														...
														<!--begin::Col-->
														<div class="col-lg-8 fv-row">
															<input type="text" name="user_nama" class="form-control form-control-lg form-control-solid" value="<?= $_SESSION['nama'];  ?>" />
														</div>
														<!--end::Col-->
													</div>
													<!--end::Input group-->
													...
													<div class="row mb-6">
														...
														<!--begin::Col-->
														<div class="col-lg-8 fv-row">
															<input type="tel" name="user_telp" class="form-control form-control-lg form-control-solid" value="<?= $_SESSION['no_telp'];  ?>" />
														</div>
														<!--end::Col-->
													</div>
													<!--end::Input group-->
													...
													<div class="row mb-6">
														...
														<!--begin::Input-->
														<div class="col-lg-8 fv-row">
															<textarea name="user_alamat" class="form-control form-control-lg form-control-solid"><?= $_SESSION['alamat'];  ?></textarea>
														</div>
														<!--end::Input-->
													</div>
													<!--end::Input group-->
													...
													<div class="row mb-6">
														...
														<div class="col-lg-8 fv-row">
															<?php
															$selectedAdmin = $_SESSION['kategori_user'] == 'Admin' ? 'selected' : '';
															$selectedUser = $_SESSION['kategori_user'] == 'User' ? 'selected' : '';
															$selectedDriver = $_SESSION['kategori_user'] == 'Driver' ? 'selected' : '';
															?>
															<!--begin::Input-->
															<select name="user_role" data-control="select2" class="form-select form-select-solid fw-bold">
																...
																<option value="Driver" <?= $selectedDriver; ?>>Driver</option>
															</select>
														</div>
														<!--end::Input-->
													</div>
										...
										<div class="card-body border-top p-9">
											...
											<div class="d-flex flex-wrap align-items-center">
												...
												<div id="kt_signin_email">
													...
													<div class="fw-semibold text-gray-600"><?= $_SESSION['email'];  ?></div>
												</div>
												<!--end::Label-->
												<!--begin::Edit-->
												<div id="kt_signin_email_edit" class="flex-row-fluid d-none">
													<!--begin::Form-->
													<form action="proses/edit_email.php" method="POST" id="kt_signin_change_email" class="form" novalidate="novalidate">
														<div class="row mb-6">
															<div class="col-lg-6 mb-4 mb-lg-0">
																<div class="fv-row mb-0">
																	<label for="emailaddress" class="form-label fs-6 fw-bold mb-3">Masukan Email Baru Anda</label>
																	<input type="email" name="new_email" id="new_email" class="form-control form-control-lg form-control-solid"  value="<?= $_SESSION['email']; ?>" />
																</div>
															</div>
															<div class="col-lg-6">
																<div class="fv-row mb-0">
																	<label for="confirmemailpassword" class="form-label fs-6 fw-bold mb-3">Masukkan Sandi</label>
																	<input type="password" name="password" id="password" class="form-control form-control-lg form-control-solid" />
																</div>
															</div>
														</div>
														<div class="d-flex">
											...
											<div class="d-flex flex-wrap align-items-center mb-10">
												...
												<div id="kt_signin_password_edit" class="flex-row-fluid d-none">
													<!--begin::Form-->
													<form action="proses/edit_password.php" method="POST" id="kt_signin_change_password" class="form" novalidate="novalidate">
														<div class="row mb-1">

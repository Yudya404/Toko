								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column gap-1 me-3 mb-2">
											...
											<!--end::Breadcrumb-->
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bolder fs-1 lh-0">Laporan Pesanan Selesai</h1>
											<!--end::Title-->
										</div>
										<!--end::Page title-->
									</div>
										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-toolbar">
												...
												<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
													<!--begin::Export-->
													<button type="button" data-bs-toggle="modal" data-bs-target="#modalCetakPenjualan" class="btn btn-light-primary me-3"><i class="fa fa-print"></i>Cetak</button>
													<!--end::Export-->
													<!--begin::Modal - Cetak-->
													<div class="modal fade" id="modalCetakPenjualan" tabindex="-1" aria-hidden="true">
													<!--begin::Modal dialog-->
													<div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
														...
														<div class="modal-content">
															...
															<div class="modal-header" id="kt_modal_add_user_header">
																<!--begin::Modal title-->
																<h2 class="fw-bold">Cetak Penjualan Produk</h2>
																<!--end::Modal title-->
																<!--begin::Close-->
															...
															<div class="modal-body" id="modalBody">
																...
																<div class="modal-footer">
																	...
																	<div class="text-end">
																		...
																		<button type="button" onclick="cetakPenjualan('modalBody')" class="btn btn-primary"><i class="fa fa-print"></i>Cetak</button>
																	</div>
																</div>
															</div>
															<!--end::Modal content-->
...
<?php
	$result = mysqli_query($conn, "SELECT t.*, c.nama AS nama, c.foto_cus AS foto_cus, p.kode_b, p.alasan
								   FROM t_pesanan t
								   JOIN customer c ON t.kode_cus = c.kode_cus

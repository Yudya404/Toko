										...
										<div class="card-body pt-9 pb-0">
											...
											<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
												...
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-1 active" href="../dist/overview_user.php?kode=<?= $row['kode_user']; ?>">Detail Profil</a>
												</li>
												<!--end::Nav item-->
												<!--begin::Nav item-->
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-1" href="../dist/edit_profile_user.php?kode=<?= $row['kode_user']; ?>">Edit Profile</a>
												</li>
												<!--end::Nav item-->
											</ul>
											<!--begin::Navs-->
										...
										<div class="row g-5">
											...
											<div class="row mb-7">
												...
												<div class="col-lg-8 fv-row">
													<span class="fw-semibold text-gray-800 fs-6"><span>0</span><?= $row['no_telp'];  ?></span>
												</div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
											...
											<div class="row mb-7">
												<!--begin::Label-->
												<label class="col-lg-4 fw-semibold text-muted">Tanggal Join</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8">
											...
											<div class="row mb-7">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<span class="fw-semibold text-gray-800 fs-6"><?= $row['kategori_user'];  ?></span>
												</div>
												<!--end::Col-->
											</div>
											<?php

...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $queryUpdateStatus = "UPDATE t_pesanan SET status = 'Pesanan Sampai Tujuan', tgl_sampai = ? WHERE kode_p = ?";
    ...
    if ($stmt->execute()) {
        ...
        echo "
            <script>
               alert('Selamat Data Pesanan dengan Kode $kode_p berhasil dikirim pada tanggal $tgl_input');

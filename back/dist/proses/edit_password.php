...
if (isset($_SESSION['kode_user']) && isset($_POST['new_password']) && isset($_POST['confirm_password']) && isset($_POST['password'])) {
    ...
    if (password_verify($password, $hashed_password)) {
        ...
        $update_query = "UPDATE user SET password = ? WHERE kode_user = ?";
        $stmt_update = mysqli_prepare($conn, $update_query);
        mysqli_stmt_bind_param($stmt_update, "ss", $hashed_new_password, $kode_user);

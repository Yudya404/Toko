								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column gap-1 me-3 mb-2">
											...
											<!--end::Breadcrumb-->
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bolder fs-1 lh-0">Laporan Total Pesanan</h1>
											<!--end::Title-->
										</div>
										<!--end::Page title-->
									</div>
													...
													<div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
														...
														<div class="modal-content">
															...
															<div class="modal-header" id="kt_modal_add_user_header">
																<!--begin::Modal title-->
																<h2 class="fw-bold">Cetak Semua Pesanan</h2>
																<!--end::Modal title-->
																<!--begin::Close-->
															...
															<div class="modal-body" id="modalBody">
																...
																<div class="modal-footer">
																	...
																	<div class="text-end">
																		...
																		<button type="button" onclick="cetakSemuaPesanan('modalBody')" class="btn btn-primary"><i class="fa fa-print"></i>Cetak</button>
																	</div>
																</div>
															</div>
															<!--end::Modal content-->
						...
						<div class="row g-5">
							<div class="col-lg-6">
								<table cellpadding="6">
									...
									<div id="kt_docs_card_collapsible1" class="collapse">
										<div class="card-body">
											<div class="row g-5">
												<div class="col-lg-4">
													<div class="mb-5">
														<label for="exampleFormControlInput1" class="form-label fs-5">Status Pesanan</label>
													</div>
												</div>
												<div class="col-lg-8">
													<?php
													$selectedPesananSelesai 			= $row['status'] == 'Pesanan Selesai' ? 'selected' : '';
													$selectedPesananSampaiTujuan		= $row['status'] == 'Pesanan Sampai Tujuan' ? 'selected' : '';
													$selectedPesananDalamPengiriman 	= $row['status'] == 'Pesanan Dalam Pengiriman' ? 'selected' : '';
													$selectedPesananDiproses			= $row['status'] == 'Pesanan Diproses' ? 'selected' : '';
													$selectedPesananMenungguDiproses	= $row['status'] == 'Pesanan Menunggu Diproses' ? 'selected' : '';
													$selectedPesananDibuat		 		= $row['status'] == 'Pesanan Dibuat' ? 'selected' : '';
													$selectedPesananDibatalkan			= $row['status'] == 'Pesanan Dibatalkan' ? 'selected' : '';
													?>
													<form class="form" action="proses/proses_pesanan.php" method="POST">
														<input type="hidden" name="kode_p" value="<?= $row['kode_p']; ?>">
														<select id="status" class="form-select form-select-solid" data-hide-search="true" data-control="select2" name="status">
															<option value="Pesanan Diproses" <?= $selectedPesananDiproses; ?>>Pesanan Diproses</option>
														</select>
													</form>
												</div>
											</div>
								...
								<div class="card shadow-sm mb-5">
									...
									<div id="kt_docs_card_collapsible2" class="collapse">
										<div class="card-body">
											<div class="row g-5">
												<div class="col-lg-6">
													<div class="mb-5">
